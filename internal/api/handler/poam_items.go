...
//	@Param			dueBefore	query		string	false	"RFC3339 timestamp"
//	@Param			overdueOnly	query		bool	false	"true — items past planned_completion_date"
...
//	@Description	Update scalar fields of a POAM item. Setting status to 'completed' automatically sets completed_at.
//	@Tags			POAM Items
//	@Accept			json
//	@Produce		json
//	@Param			id		path		string				true	"POAM item ID"
...
//	@Produce	json
//	@Param		id	path		string	true	"POAM item ID"
//	@Success	200	{object}	GenericDataListResponse[relational.CcfPoamItemRiskLink]
//	@Failure	400	{object}	api.Error
//	@Failure	404	{object}	api.Error
...
//	@Produce	json
//	@Param		id	path		string	true	"POAM item ID"
//	@Success	200	{object}	GenericDataListResponse[relational.CcfPoamItemEvidenceLink]
//	@Failure	400	{object}	api.Error
//	@Failure	404	{object}	api.Error
...
//	@Produce	json
//	@Param		id	path		string	true	"POAM item ID"
//	@Success	200	{object}	GenericDataListResponse[relational.CcfPoamItemControlLink]
//	@Failure	400	{object}	api.Error
//	@Failure	404	{object}	api.Error
...
//	@Produce	json
//	@Param		id	path		string	true	"POAM item ID"
//	@Success	200	{object}	GenericDataListResponse[relational.CcfPoamItemFindingLink]
//	@Failure	400	{object}	api.Error
//	@Failure	404	{object}	api.Error

...
Also include proposed_filter_name: a short, human-readable title (a few words) describing what the dashboard filter captures, derived from the proposed_filter_labels and the control's intent. Do not include instance identifiers or the SSP name.
		...
		"properties": map[string]any{
			"mappings": map[string]any{
				...
				"items": map[string]any{
					"type":                 "object",
					"additionalProperties": false,
					"required":             []any{"control_key", "label_set_hash", "proposed_filter_name", "proposed_filter_labels", "confidence", "reasoning"},
					"properties": map[string]any{
...
{{json .Input.LabelKeyDocs}}{{if .ConstraintsText}}
